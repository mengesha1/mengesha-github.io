  ...
  const handleChange = (event: React.ChangeEvent<HTMLTextAreaElement>) => {
    ...
    const clearTextarea = () => {
      if (textareaRef.current) {
        textareaRef.current.value = ""; // Clear the value using the ref
      }
    };
...
const textareaRef = useRef<HTMLTextAreaElement>(null);
  //const [inputValue,setInputValue] = useState(" ")//controled component
  
//const textareaRef=useRef<HTMLTextAreaElement>(null) //uncontrolled component
